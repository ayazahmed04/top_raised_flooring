...
const Footer  = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_ft3hmwk', 'template_ux9tiov', form.current, 'xt7zfvlSNC7XJE-m1')
            .then((result) => {
            ...
            <div className="container mt-24 mx-auto px-4">
                ...
                <div className="mb-8">
                    ...
                    <div className="flex space-x-4 mt-4">
                        ...
                        <a href="https://www.facebook.com/profile.php?id=61565542242315" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-blue-700">
                        ...
                        <a href="whatsapp://send?phone=+971 56 596 9600" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-blue-800">
                            <FontAwesomeIcon icon={faWhatsapp} target='_blank' size="3x" />
                        </a>
